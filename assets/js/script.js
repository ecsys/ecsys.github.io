...
// Function to display hidden photo content in index page
...
window.onload = function (){    
    ...
    bigImg.src="http://img4.douban.com/view/photo/raw/public/p579561327.jpg" //给img元素的src属性赋值  
    bigImg.style.display="none";
	bigImg.setAttribute("id", "hiddenImg");  
    var myDiv = document.getElementById('noNew'); //获得dom对象  
